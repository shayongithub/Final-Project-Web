    ...
    <div id="wrapper">
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php
					$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `room_detail` WHERE `transaction_id` = '$_REQUEST[transaction_id]'") or die(mysqli_error());
				...
				<form method = "POST" enctype = "multipart/form-data" action = "save_form.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<div class = "form-inline" style = "float:left;">
						<label>Room ID</label>
						<br />
						<input type = "text" value = "<?php echo $fetch['room_id']?>" class = "form-control" size = "20" disabled = "disabled"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Room No</label>
						<br />
