...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					$re1 = $conn->query("select count(transaction_id) as total_row from transaction WHERE DATEDIFF(NOW(), checkin) <= 7;");
                                        $valid = $re1->num_rows;
                                        ...
                                        if($valid > 0)
					{
						...
						echo "                                <div >\n";
						echo "                                    <h3 class=\"text-xs font-weight-bold text-success text-uppercase mb-1\">\n";
						echo "                                        New Booking in Last 7 days\n";
						echo "                                    </h3>\n";
						echo "                                    <p class=\"h5 mb-0 font-weight-bold text-gray-800\">\n";
						echo "                                        ".$row['total_row']."\n";
						echo "                                    </p>\n";
						echo "                                </div>\n";
						echo "                                <div class=\"icon\">\n";
				...
				?>
					...
					$server_name = "fdb21.awardspace.net";
                                        ...
                                        $database = "3849092_heyshay";
                                        $conn = new mysqli($server_name, $username, $password, $database);
                                        $re2 = $conn->query("select count(transaction_id) as total_row from transaction WHERE status like 'pend%';");
                                        $valid = $re2->num_rows;
				...
				?>
					...
					$server_name = "fdb21.awardspace.net";
                                        ...
                                        $database = "3849092_heyshay";
                                        $conn = new mysqli($server_name, $username, $password, $database);
                                        $re3 = $conn->query("select count(transaction_id) as total_row from transaction WHERE status  ='Check out';");
                                        $valid = $re3->num_rows;
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Money
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Social
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Guests
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Electricity <span
                                    ...
                                    <h4 class="small font-weight-bold">Water <span
                        ...
                        <div class="col-lg-6 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="/homestay/admin/public/img/undraw_posting_photo.svg" alt="...">
                                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>This is admin website to manage hotel.</p>
    ...
    <!-- Page level plugins -->
    <script src="/homestay/admin/public/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/homestay/admin/public/js/demo/chart-area-demo.js"></script>
    <script src="/homestay/admin/public/js/demo/chart-pie-demo.js"></script>
