				...
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name ="type_room">
						...
						<div class = "form-group" >
							...
							<input type = "number" min = "0" max = "5" class = "form-control" name = "max_people" />
						</div>
                                                
                                                <div class = "form-group">
							<label>Area(m2)</label>
							<input type = "number" min = "0" max = "20" class = "form-control" name = "area" />
						</div>
                                                <div class = "form-group">
							<label>Note </label>
