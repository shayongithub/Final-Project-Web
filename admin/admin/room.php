				...
				<table id = "table" class = "table table-bordered">
					<thead>
						<tr>
							...
							<th>Room Type</th>
							<th>Price</th>
                                                        <th>Available(1 is available)</th>
							<th>Photo</th>
							<th>Action</th>
						</tr>
					</thead>
					<tbody>
					<?php
						$query = $conn->query("SELECT * FROM room_detail 
                                                INNER JOIN homestay_room on room_detail.room_id = homestay_room.room_id 
                                                INNER JOIN homestay_info on homestay_room.homestay_id = homestay_info.homestay_id") or die(mysqli_error());
					...
					?>	
						<tr>
							...
							<td><?php echo $fetch['type_room']?></td>
                                                        ...
                                                        <td><a class = "btn btn-success"><i class = "glyphicon glyphicon-check"></i><?php echo $fetch['available']?></a></td>
							<td><center><img src = "<?php echo $fetch['image']?>"  height = "50" width = "50"/></center></td>
